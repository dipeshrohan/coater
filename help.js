...
const HELP = {
  ...
  'in.L': { d: 'Length of the flat land under the blade (the flat-land blade shape).', e: 'Longer: more resistance to the pressure-driven flow, a thinner film at a given bead pressure.', u: 'Start-up, Contact line, CFD (flat land), the DOE' },
