...
const HELP = {
  ...
  // blade and bead
  'in.Pup': { d: 'Gauge pressure of the slurry bead upstream of the blade, pushing it into the gap. Set to give a 1.45 mm film at the defaults.', e: 'Higher: more flow through the gap, a thicker film, the contact line climbs higher.', u: 'Overview, Contact line, CFD, the DOE' },
  'in.L': { d: 'Length of the flat land under the blade (the flat-land blade shape).', e: 'Longer: more resistance to the pressure-driven flow, a thinner film at a given bead pressure.', u: 'Overview, Contact line, CFD (flat land), the DOE' },
  'in.th': { d: 'Contact angle of the slurry on the blade\'s exit face (wetting). Assumed.', e: 'Smaller (better wetting): the meniscus climbs further up the exit face, toward the notch corner.', u: 'Overview, Contact line, CFD, the DOE' },
  'in.face': { d: 'Length of the blade\'s exit face from the metering edge up to the notch corner. Measure it on the blade.', e: 'Shorter: the contact line reaches the corner, and the slurry the dry edge, sooner.', u: 'Overview, Contact line' },
  // across the web
  'in.dH': { d: 'Amplitude of the sinusoidal variation of the gap along the blade (blade straightness, deflection).', e: 'Larger: the local gap, film and contact line vary more across the web.', u: 'Overview, Contact line, CFD (the locations\' gaps)' },
  'in.lw': { d: 'Wavelength of that gap variation along the blade.', e: 'Sets where across the web the gap is widest and narrowest.', u: 'Overview, Contact line, CFD (the locations\' gaps)' },
  'in.dt': { d: 'Random variation of the fibre thickness across the web.', e: 'Larger: the local gap varies more, adding irregular streaks.', u: 'Overview, Contact line, CFD (the locations\' gaps)' },
  'in.dth': { d: 'Variation of the contact angle along the blade, e.g. from contamination or dried residue.', e: 'Larger: the contact line climbs unevenly, and reaches the corner first where wetting is best.', u: 'Overview, Contact line, CFD (the locations\' contact angles)' },
  // web edge and film
