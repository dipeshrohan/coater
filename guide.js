...
const GUIDE = [
  ...
  { tab: 4, t: 'Flow (CFD)', what: '2D Navier–Stokes flow under the blade, over its exit face and into the free film, with the meniscus and its contact line solved together with the flow, at four positions across the web. Velocity, pressure, shear, viscosity and more, post-processed from the stored solutions.',
  ...
  { tab: 5, t: 'DOE', what: 'A full-factorial design of experiments at one location: 1–3 factors (process, slurry, blade geometry, mesh) at 2–5 levels each, every combination solved in the CFD, several at a time.',
    uses: 'The CFD base case of the chosen location (every input as in Flow (CFD)), and the factors in the Design tab.',
