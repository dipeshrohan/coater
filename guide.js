...
const GUIDE = [
  ...
  { tab: 4, t: 'CFD Analysis', what: '2D Navier–Stokes flow under the blade, over its exit face and into the free film, with the meniscus and its contact line solved together with the flow, at four positions across the web. Velocity, pressure, shear, viscosity and more, post-processed from the stored solutions.',
    uses: 'Process, Slurry, Blade and bead, Variation across the web (each location\'s local gap and contact angle), and the CFD setup in the Model bar (blade entry, exit face, rheology model, fibre, air, solver and mesh, locations with their own inputs).',
  ...
  { tab: 5, t: 'DOE', what: 'A full-factorial design of experiments at one location: 1–3 factors (process, slurry, blade geometry, mesh) at 2–5 levels each, every combination solved in the CFD, several at a time.',
    uses: 'The CFD base case of the chosen location (every input as in CFD Analysis), and the factors in the Design tab.',
