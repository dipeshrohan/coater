...
const GUIDE = [
  ...
  { tab: 9, t: '3D', what: 'Not built yet. Next: the 3D geometry (the blade made here from its dimensions, or an STL or STEP file of the blade) and a 3D view; then the 3D Navier–Stokes solve with the meniscus and the film surface.',
    uses: '—',
    read: 'For now the page shows the 1D / 2D / 3D table with the 3D column empty.' },
